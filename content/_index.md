...
sections:
  - block: resume-biography-3
    content:
      ...
      button:
        text: Download CV
        url: uploads/xufangbing-resume.pdf
    design:
      css_class: dark
      background:
        color: black
